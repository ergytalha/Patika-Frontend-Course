    ...
    return ( 
      ...
      <div className="container">
        ...
        <div className="classes-btns" id="class-btns">
          <button href="#" className="classes-btn active" id="yoga">Yoga</button>
          <button href="#" className="classes-btn" id="group">Group</button>
          <button href="#" className="classes-btn" id="solo">Solo</button>
        ...
        <div className="classes-content">
          <div className="clases-text">
            ...
            <p id="featuresP">
              ...
              perspiciatis vero mollitia temporibus placeat enim! Veritatis
              doloremque obcaecati placeat asperiores soluta, vel voluptatem
              laudantium ullam possimus. Quisquam, eum aliquid?
            </p>
